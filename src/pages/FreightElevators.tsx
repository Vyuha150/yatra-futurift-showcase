    ...
    <PageLoadWrapper>
      ...
      <section className="px-6 py-16 bg-surface-glass">
        <div className="container mx-auto grid items-center gap-10 md:grid-cols-2">
          <motion.img
            src="/src/images/Yatra website_Freight elevators (size - 400-300).png"
            alt="Home Elevator"
          ...
          <div>
            ...
            <p className="mb-6 text-lg text-muted-foreground">
              Yatra’s Freight and Service Elevators are designed for maximum
              potential, solidity and firmness, and flawless performance in
              rigorous environments. Specifically engineered for heavy-duty
              commercial use.
            </p>
