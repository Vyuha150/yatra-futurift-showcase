      ...
      <section className="pt-24 pb-16 px-6" ref={heroRef}>
        <div className="container mx-auto">
          ...
          >
            ...
            >
              For more than fifteen years, ICONIC Group has built a reputation grounded in brilliance, trust, and innovation.
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 px-6">
        <div className="container mx-auto">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-foreground mb-6">Our Legacy: The ICONIC Group</h2>
            <p className="text-xl text-muted-foreground leading-relaxed max-w-4xl mx-auto">
              What initiated as a visionary venture in shaping homes and office spaces from two to three-bedroom residences to expansive duplex and triplex villas, and also extensive materialistic interiors has grown into a hybrid legacy that touched numerous lives.
            </p>
          </motion.div>
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Throughout the years, our pioneering spirit has guided us to expand over innumerable industries. Today, the ICONIC Group pridefully operates in multiple verticals, each reflecting our commitment in molding a better future one that is Eco-Friendly, inclusive, and ingenious.
              </p>
      ...
      <section className="py-16 px-6 bg-surface-glass">
        <div className="container mx-auto">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-foreground mb-4">Our Verticals</h2>
            <p className="text-muted-foreground">Diverse industries, unified excellence</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                ...
                <h3 className="text-sm font-semibold text-foreground">{vertical.title}</h3>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto">
          ...
          >
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-foreground mb-6">Why Elevators & Escalators?</h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Our journey into Elevators & Escalators is not just a supplement of our engineering potentiality, but a tactical move positioned with our mission to form forward-thinking surroundings. With urbanization and sustainable cities rising rapidly, we recognize an accelerating gap in authentic, energy-efficient, and brilliantly designed mobility solutions.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  This new vertical, <span className="text-neon-cyan font-semibold">Yatra</span>, represents an influential joining of innovation, safety, and sustainability. Through Yatra, we aim to associate with people, spaces, and possibilities—seamlessly and sustainably.
                </p>
              </div>
            ...
            {[
              {
                icon: Lightbulb,
                title: "Brilliance",
                description: "Brilliance navigates us to excel expectations with each and every delivery."
              },
              {
                icon: Shield,
                title: "Righteousness", 
                description: "Righteousness designs how we function with honesty, impartiality, and respect for all stakeholders."
              },
              {
                icon: Heart,
      ...
      <section className="py-16 px-6 bg-surface-glass">
        <div className="container mx-auto">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-foreground mb-6">Sustainability & Green Practices</h2>
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              At ICONIC Group, sustainability is not considered as secondary - it stands as our primary focus and it is our focal point of our innovation and purpose.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                Yatra elevators and escalators are not just technologically advanced but they are also built to sync with green building standards like LEED and IGBC. We collaborate with architects, developers, and government bodies to assure that our vertical mobility solutions contribute purposefully & meaningfully to infrastructure goals.
              </p>
            </motion.div>
          ...
          >
            {[
              { icon: Zap, title: "Energy Efficient Machinery", desc: "Usage of energy efficient machinery" },
              { icon: Recycle, title: "Zero-Waste Protocols", desc: "Mandatory Implementation of zero-waste protocols" },
              { icon: Globe, title: "Water Conservation", desc: "water consumption in a more reducible way" },
              { icon: Leaf, title: "Sustainable Materials", desc: "Procurement of sustainable raw materials whenever possible" }
            ].map((item, index) => (
              <motion.div 
                key={item.title}
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                Our engineers and designers constantly prospect new technologies, sustainable systems, smart automation, and improving safety features. Whether it's adjustable control systems or eco-friendly materials, our R&D efforts will entitle us to create smarter, safer, and more sustainable mobility experiences.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-surface-glass">
        <div className="container mx-auto">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-foreground mb-6">Corporate Social Responsibility (CSR)</h2>
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
          ...
          >
            <p className="text-muted-foreground leading-relaxed">
              We firmly believe that real progress is not just quantified by technological innovation, but by the positive influence and enhancement we create in the communities we serve. Our attempts are strongly rooted in empathy, bringing out the potential of empowering leadership. We are dedicated to lighting and raising up the deprived and needy communities through our programs.
            </p>
          </motion.div>
        </div>
      </section>
