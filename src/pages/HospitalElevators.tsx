    ...
    <PageLoadWrapper>
      ...
      <section className="px-6 py-16 bg-surface-glass">
        <div className="container mx-auto grid items-center gap-10 md:grid-cols-2">
          <motion.img
            src="/WhatsApp Image 2025-08-19 at 11.00.21 AM.jpeg"
            alt="Home Elevator"
          ...
          <div>
            ...
            <p className="mb-6 text-lg text-muted-foreground">
              Yatra’s Hospital/Bed Elevators Instituted with quiet, controlled
              acoustic environments, structural integrity, and advanced medical
              equipment and accommodations that prioritizes patient convience
