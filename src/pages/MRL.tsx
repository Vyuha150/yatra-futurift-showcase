    ...
    <PageLoadWrapper>
      ...
      <section className="px-6 py-16 bg-surface-glass">
        <div className="container mx-auto grid items-center gap-10 md:grid-cols-2">
           <motion.img
            src="/src/images/Yatra website_MRL elevators(size - 400-300).png"
            alt="Home Elevator"
          ...
          <div>
            ...
            <p className="mb-6 text-lg text-muted-foreground">
             Yatra’s Machine-Room Less (MRL) Elevators are developed with advanced, sophisticated infrastructure where the space consumption is minimized. Designed in such a way that without the necessity of a traditional mechanical room, these elevators provide strong installation, reduced consumption.</p>
            <ul className="space-y-3 text-muted-foreground">
              <li>✔ Sophisticated infrastructure</li>
              <li>✔ Strong installation</li>
              <li>✔ Enhanced architectural flexibility</li>
            </ul>
          </div>
        </div>
      </section>
