...
const searchIndex: { path: string; aliases: string[] }[] = [
  ...
  {
    path: "/opportunities",
    aliases: ["opportunities", "openings", "vacancies"],
  },
  {
    path: "/projects",
    aliases: ["projects", "products", "solutions", "products & solutions"],
  },
  {
    path: "/innovations",
    aliases: ["innovations", "tech", "technology", "r&d"],
  },
  {
    path: "/support",
    aliases: ["support", "support & services", "services", "service"],
  },
  {
    path: "/contact",
    aliases: ["contact", "contact us", "reach us", "help", "support team"],
  },
  ...
  { path: "/FeedBack", aliases: ["feedback", "suggestion", "complaint"] },
  {
    ...
    aliases: ["service request", "raise ticket", "ticket"],
  },
  { path: "/clientForm", aliases: ["client form", "client"] },
  {
    path: "/quotationform",
    aliases: ["quotation", "quote", "price quotation"],
  },

  // Elevators & Escalators
  {
    path: "/passenger-elevators",
    aliases: ["passenger", "passenger elevators", "elevators", "lifts"],
  },
  {
    path: "/freight-elevators",
    aliases: ["freight", "freight elevators", "cargo", "goods lift"],
  },
  {
    path: "/hospital-elevators",
    aliases: ["hospital", "hospital elevators", "stretcher lift"],
  },
  {
    path: "/glass-elevators",
    aliases: ["glass", "glass elevators", "panoramic elevators"],
  },
  ...
  { path: "/cabins", aliases: ["cabins", "cabin showcase", "car interiors"] },
  {
    ...
    aliases: ["moving walkways", "walkways", "travelator"],
  },
  {
    path: "/public-transport-escalators",
    aliases: ["public escalators", "escalators", "metro escalators"],
  },
];
          ...
          <div className="space-y-2 lg:space-y-3 max-w-lg">
            <div className="space-y-4 lg:space-y-6">
              ...
              <SlideInAnimation direction="right" delay={1.5}>
                <p className="text-base sm:text-lg lg:text-lg text-muted-foreground leading-snug max-w-md mb-4">
                  Advanced elevators and escalators for residential towers,
                  Hotels workspaces, malls, and hospitals – powered by 24/7
                  service and future-ready tech.
                </p>
              </SlideInAnimation>
            </div>
            ...
            {/* CTAs */}
            <motion.div
              className="flex flex-wrap gap-2 lg:gap-3 mb-6"
            ...
            {/* 🔍 Search Bar */}
            <motion.div
              className="w-full sm:w-[95%] md:w-[90%] lg:w-[88%] xl:w-[88%]"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
