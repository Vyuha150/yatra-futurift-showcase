  ...
  const products = [
    {
      ...
      description: "Whether it's for receiving guests or day-to-day accessibility, our premium home elevators allow you to move between floors within your residence with ease and comfort.",
      features: ["Compact Design", "Energy Efficient", "Silent Operation", "Custom Interiors"]
    },
    {
      id: "02", 
      title: "Capsule Elevators",
      description: "Transparent glass elevators that offer scenic views while ensuring safety and reliability. Perfect for hotels, malls, and premium residential buildings.",
      features: ["360° Views", "Weather Resistant", "LED Lighting", "Premium Finish"]
    },
    {
      id: "03",
      title: "Hospital Elevators",
      description: "Specially designed for medical facilities with stretcher compatibility, smooth operation, and infection control features for patient safety.",
      features: ["Stretcher Compatible", "Infection Control", "Emergency Backup", "Silent Operation"]
    },
    {
      id: "04",
      title: "Goods Elevators",
      description: "Heavy-duty freight elevators designed for industrial and commercial use with superior load capacity and durability.",
      features: ["High Load Capacity", "Industrial Grade", "Safety Systems", "Multiple Entry Points"]
    },
    {
      id: "05",
      title: "Escalators", 
      description: "Modern escalator systems for shopping malls, airports, and commercial complexes with advanced safety features.",
      features: ["Smart Controls", "Energy Saving", "Safety Sensors", "Weather Protection"]
    },
    {
      id: "06",
      title: "Dumbwaiters",
      description: "Small freight elevators perfect for restaurants, hotels, and homes for efficient material transport between floors.",
    ...
    <section id="products" className="py-20 relative">
      <div className="container mx-auto px-6">
        ...
        <div className="flex items-center justify-between mb-12">
          <h2 className="text-4xl lg:text-5xl font-bold text-foreground">Products</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {products.map((product, index) => {
            ...
            return (
              <div
                key={product.id}
                className={`card-glow p-8 transition-all duration-500 ${
                  isActive ? 'scale-105 shadow-glow' : ''
        ...
        <div className="card-glow p-8 lg:p-12 bg-gradient-to-r from-brand-slate to-brand-slate-light relative overflow-hidden">
          <div className="relative z-10 grid lg:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              <div>
                <p className="text-neon-cyan text-sm font-semibold mb-2">YATRA ELEVATORS</p>
                <h3 className="text-3xl font-bold text-foreground mb-4">Feel free to try demo</h3>
                <p className="text-muted-foreground leading-relaxed">
                  We will demonstrate how our products work and explain all the features. 
                  Experience our IoT-enabled monitoring system and smart controls.
                </p>
              </div>
