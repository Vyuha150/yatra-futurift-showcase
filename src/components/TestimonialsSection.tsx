  ...
  const testimonials = [
    {
      ...
      location: "Mumbai",
      testimonial:
        "Yatra delivered exactly what they promised. The installation was smooth, and the IoT monitoring gives us complete peace of mind.",
    ...
    },
    {
      ...
      location: "Bangalore",
      testimonial:
        "The touchless controls and smart monitoring system have been game-changers for our office building. Excellent service quality.",
      client: "Priya Menon",
    ...
    },
    {
      ...
      location: "Delhi",
      testimonial:
        "From quote to installation, everything was handled professionally. The residents love the silent operation and modern design.",
      client: "Amit Kumar",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            See how we've transformed vertical transportation across
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="card-glow p-8 space-y-6 group hover:scale-102 transition-all duration-300"
            >
              {/* Project Header */}
